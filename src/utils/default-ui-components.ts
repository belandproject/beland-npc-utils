...
export let lightTheme = new Texture('https://beland.io/images/ui/light-atlas-v3.png')
export let darkTheme = new Texture('https://beland.io/images/ui/dark-atlas-v3.png')

export let bubblesTexture = new Texture('https://beland.io/images/ui/dialog-bubbles.png')
